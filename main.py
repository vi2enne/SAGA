...
from saga.train import run_saga

parser = argparse.ArgumentParser()

# Environment
parser.add_argument("--env_name", required=True, type=str)
parser.add_argument("--algo", default="saga", type=str)
...
parser.add_argument("--dm_weight_hl", default=5.0, type=float)
parser.add_argument("--dm_weight_ll", default=5.0, type=float)
parser.add_argument("--n_timesteps", default=5, type=int) # diffusion time steps
